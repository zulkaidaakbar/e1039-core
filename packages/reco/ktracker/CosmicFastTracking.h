...
#ifndef _COSMICFASTTRACKING_H
#define _COSMICFASTTRACKING_H
...
{
public:
    explicit CosmicFastTracking(const PHField* field, const TGeoManager *geom, bool flag = true);
    ~CosmicFastTracking();
